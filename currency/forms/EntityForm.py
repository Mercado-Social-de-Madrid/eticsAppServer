...
class EntityForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'max_percent_payment': forms.NumberInput(attrs={'class': 'form-control', 'readonly': True}),
            'bonus_percent_general': forms.NumberInput(attrs={'class': 'form-control', 'readonly': True}),
            'bonus_percent_entity': forms.NumberInput(attrs={'class': 'form-control', 'readonly': True}),
